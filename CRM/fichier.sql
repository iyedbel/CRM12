...
CREATE TABLE colis (
    ...
    statut ENUM('fragile', 'openable', 'livraison_vendeur', 'echec') DEFAULT 'livraison_vendeur',
    type_vente VARCHAR(50) NOT NULL,
    date_creation DATE
);

INSERT INTO colis (
    nom_produit, nom_client, adresse, wilaya, type_livraison, prix_vente,
    quantite, poids, prix_livraison, statut, type_vente, date_creation
) VALUES 
(
    'Produit A', 'Client A', '123 Rue Exemple', 'Wilaya A', 'A Domicile', 99.99,
